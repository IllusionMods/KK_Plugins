...
namespace KK_UncensorSelector
{
    class Hooks
    {
        ...
        public static void SetBodyBaseMaterial(ChaControl __instance) => KK_UncensorSelector.GetController(__instance)?.UpdateSkinColor();
        /// <summary>
        ...
        public static void VisibleAddBodyLine(ChaControl __instance) => KK_UncensorSelector.GetController(__instance)?.UpdateSkinLine();
        /// <summary>
        ...
        public static void ChangeSettingSkinGlossPower(ChaControl __instance) => KK_UncensorSelector.GetController(__instance)?.UpdateSkinGloss();
        /// <summary>
        /// Demosaic
        /// </summary>
