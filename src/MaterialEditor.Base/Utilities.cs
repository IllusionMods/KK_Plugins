...
namespace MaterialEditorAPI
{
    ...
    internal class OpenFileDialog
    {
        ...
        public static string[] ShowDialog(string title, string initialDir, string filter, OpenSaveFileDialgueFlags flags, IntPtr owner)
        {
        ...
        /// This member can be a combination of the CommomDialgueFlags.
        /// </param>
        public static void Show(Action<string[]> onAccept, string title, string initialDir, string filter, OpenSaveFileDialgueFlags flags = SingleFileFlags)
        {
            ...
            new Thread(
                () =>
                {
                    var result = ShowDialog(title, initialDir, filter, flags, handle);
                    onAccept(result);
                }).Start();
        }
