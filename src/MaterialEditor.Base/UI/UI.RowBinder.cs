...
{
    // Projects a RowModel onto the controls of a reusable RowView.
    internal sealed class RowBinder : MonoBehaviour
    {
        ...
        public LabelClickTrigger RendererTextClickTrigger;
        ...
        public LabelClickTrigger MaterialTextClickTrigger;
        ...
        public LabelClickTrigger ShaderLabelClickTrigger;
        ...
        public LabelClickTrigger ShaderRenderQueueLabelClickTrigger;
        ...
        public Button PropertyCategoryCollapseButton;
        public Text PropertyCategoryLabel;

        public CanvasGroup TexturePanel;
        public Text TextureLabel;
        public LabelClickTrigger TextureLabelClickTrigger;
        ...
        public LabelClickTrigger OffsetScaleLabelClickTrigger;
        public Text OffsetXText;
        public LabelClickTrigger OffsetXTextClickTrigger;
        ...
        public LabelClickTrigger ColorLabelClickTrigger;
        ...
        public LabelClickTrigger FloatLabelClickTrigger;
        ...
        public LabelClickTrigger KeywordLabelClickTrigger;
        ...
        {
            if (!force && ReferenceEquals(item, _currentModel)) return;

            _currentModel = item;

            ClearLabelClickHandlers();
            PropertyCategoryCollapseButton.onClick.RemoveAllListeners();
            HideAll();
            if (item != null)
            {
                switch (item.ItemType)
                {
                    case RowModel.RowItemType.Renderer:
                        ...
                        ConfigureLabelClick(RendererTextClickTrigger, item, MaterialEditorLabelType.Renderer, () => item.RendererName);
                        break;
                    ...
                    case RowModel.RowItemType.Material:
                        ...
                        ConfigureLabelClick(MaterialTextClickTrigger, item, MaterialEditorLabelType.Material, () => item.MaterialName);
                    ...
                    case RowModel.RowItemType.Shader:
                        ...
                        ConfigureLabelClick(ShaderLabelClickTrigger, item, MaterialEditorLabelType.Shader, () => item.ShaderName);
                    ...
                    case RowModel.RowItemType.ShaderRenderQueue:
                        ...
                        ConfigureLabelClick(ShaderRenderQueueLabelClickTrigger, item, MaterialEditorLabelType.ShaderRenderQueue, () => item.LabelText);

                        break;
                    case RowModel.RowItemType.PropertyCategory:
                        ShowPropertyCategory();
                        SetLabelText(PropertyCategoryLabel, item.LabelText);
                        PropertyCategoryCollapseButton.GetComponentInChildren<Text>().text = item.CategoryCollapsed ? "+" : "-";
                        PropertyCategoryCollapseButton.onClick.AddListener(() =>
                        {
                    ...
                    case RowModel.RowItemType.TextureProperty:
                        ...
                        ConfigureLabelClick(TextureLabelClickTrigger, item, MaterialEditorLabelType.TextureProperty, () => item.PropertyName);
                        break;
                    case RowModel.RowItemType.TextureOffsetScale:
                        ...
                        ConfigureLabelClick(OffsetScaleLabelClickTrigger, item, MaterialEditorLabelType.TextureOffsetScale, () => item.PropertyName);
                        ConfigureLabelClick(OffsetXTextClickTrigger, item, MaterialEditorLabelType.TextureOffsetScale, () => item.PropertyName);
                        break;
                    case RowModel.RowItemType.ColorProperty:
                        ...
                        ConfigureLabelClick(ColorLabelClickTrigger, item, MaterialEditorLabelType.ColorProperty, () => item.PropertyName);
                    ...
                    case RowModel.RowItemType.FloatProperty:
                        ...
                        ConfigureLabelClick(FloatLabelClickTrigger, item, MaterialEditorLabelType.FloatProperty, () => item.PropertyName);
                        break;
                    case RowModel.RowItemType.KeywordProperty:
                        ...
                        ConfigureLabelClick(KeywordLabelClickTrigger, item, MaterialEditorLabelType.KeywordProperty, () => item.PropertyName);
                        break;
                }
            }
        }
        ...
        private static void ConfigureLabelClick(LabelClickTrigger trigger, RowModel item, MaterialEditorLabelType labelType, Func<string> getName)
        {
            trigger.Clicked = pointerEventData => MaterialEditorUI.RaiseLabelClicked(
        ...
        private void ClearLabelClickHandlers()
        {
            RendererTextClickTrigger.Clicked = null;
            MaterialTextClickTrigger.Clicked = null;
            ShaderLabelClickTrigger.Clicked = null;
            ShaderRenderQueueLabelClickTrigger.Clicked = null;
            TextureLabelClickTrigger.Clicked = null;
            OffsetScaleLabelClickTrigger.Clicked = null;
            OffsetXTextClickTrigger.Clicked = null;
            ColorLabelClickTrigger.Clicked = null;
            FloatLabelClickTrigger.Clicked = null;
            KeywordLabelClickTrigger.Clicked = null;
        }
