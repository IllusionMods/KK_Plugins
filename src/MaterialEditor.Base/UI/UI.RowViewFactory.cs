...
- Shadows Only: Renderer is invisible but still casts shadows");
            ...
            //Offset and Scale
            {
                ...
                InputField textBoxOffsetX = MaterialEditorControlFactory.CreateInputField("OffsetXInput", itemPanel.transform);
                ...
                InputField textBoxOffsetY = MaterialEditorControlFactory.CreateInputField("OffsetYInput", itemPanel.transform);
                ...
                InputField textBoxScaleX = MaterialEditorControlFactory.CreateInputField("ScaleXInput", itemPanel.transform);
                ...
                InputField textBoxScaleY = MaterialEditorControlFactory.CreateInputField("ScaleYInput", itemPanel.transform);
            ...
            //Float properties
            {
                ...
                InputField textBoxFloat = MaterialEditorControlFactory.CreateInputField("FloatInputField", itemPanel.transform);
                textBoxFloat.text = "0";
