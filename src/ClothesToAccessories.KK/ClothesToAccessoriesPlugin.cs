...
namespace KK_Plugins
{
    ...
    public partial class ClothesToAccessoriesPlugin : BaseUnityPlugin
    {
        ...
        private static void InitializeMakerWindows()
        {
            ...
            var originalOptionCount = origDropdownOptions.Count;//GetComponentInParent<ActivateHDropDown>().targetList.Count; //cac.ddAcsType.options.Count;
        ...
        internal static void UpdateVisibleAccessoryClothes(ChaControl __instance)
        {
            ...
            {
                return;
                var flag = true;//!__instance.nowCoordinate.clothes.parts[(int)kind].hideOpt[0];
                var flag2 = true;//!__instance.nowCoordinate.clothes.parts[(int)kind].hideOpt[1];
