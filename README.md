...
#### KK_CharaMakerLoadedSound - [Download](https://github.com/DeathWeasel1337/KK_Plugins/releases/download/v2/KK_CharaMakerLoadedSound.v1.0.zip)
Plays a sound when the Chara Maker finishes loading. Useful if you spend the load time alt-tabbed.

#### KK_StudioSceneLoadedSound - [Download](https://github.com/DeathWeasel1337/KK_Plugins/releases/download/v2/KK_StudioSceneLoadedSound.v1.0.zip)
...
#### KK_ForceHighPoly - [Download](https://github.com/DeathWeasel1337/KK_Plugins/releases/download/v2/KK_ForceHighPoly.v1.0.zip)
...
#### KK_GUIDMigration - [Download](https://github.com/DeathWeasel1337/KK_Plugins/releases/download/v2/KK_GUIDMigration.v1.0.zip)
